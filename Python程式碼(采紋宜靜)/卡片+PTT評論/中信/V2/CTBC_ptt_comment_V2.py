...
url_list = []
 ...
 # 開啟CSV檔案
with open('CTBC_ptt_tittle_V2.csv', 'r', encoding = 'utf-8') as file:
    #  建立CSV讀取器
...
data.to_csv('CTBC_ptt_comment_V2.csv', index=False, encoding='utf-8-sig')

data = pd.read_csv('CTBC_ptt_comment_V2.csv', encoding='utf-8-sig', delimiter=',')
