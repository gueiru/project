...
# 設定目標看板和關鍵字
board = 'creditcard'
keywords = ["Agoda聯名卡", "Mitsui Shopping Park LaLaport聯名卡", "中華航空聯名卡", "ALL ME卡", "LINE Pay信用卡", "英雄聯盟信用卡", "中油聯名卡" ,"中信商旅鈦金卡", "TAIPEI 101 聯名卡", "和泰聯名卡", "Yahoo聯名卡", "中國信託鼎極卡", "中信紅利御璽卡", "中信紅利晶緻卡", "中信現金回饋御璽卡", "中信現金回饋鈦金卡", "中信紅利卡", "寰遊美國運通卡", "iPlan卡", "Super Life VISA卡", "ANA聯名卡", "中信兄弟聯名卡", "大中華攜手飛聯名卡", "LEXUS聯名卡", "中信商務卡/雙幣商務卡", "中華電信聯名卡", "漢神百貨聯名卡", "Global Mall聯名卡", "秀泰聯名卡", "大葉髙島屋百貨聯名卡", "南紡購物中心聯名卡", "勤美天地聯名卡", "MUJI無印良品聯名卡", "酷玩卡", "商旅卡", "分期紅利卡", "統一企業認同卡", "享想生活卡"]
...
df.to_csv('CTBC_ptt_tittle.csv', index=False, encoding = 'utf-8-sig')
print("已完成")
