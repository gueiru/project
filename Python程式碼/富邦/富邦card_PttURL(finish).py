...
if response.status_code == 200:
    ...
    filtered_card_names = list(set([card for card in card_names if card.endswith("卡") and not card.endswith("簽帳金融卡")]))
else:
...
df.to_csv('富邦card_PttURL.csv', index=False, encoding='utf-8-sig')
print("已完成")
