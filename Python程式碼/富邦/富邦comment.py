...
url_list = []
 ...
 # 開啟CSV檔案
with open('富邦card_PttURL.csv', 'r', encoding = 'utf-8') as file:
    #  建立CSV讀取器
...
for url in url_list:
    ...
    if response.status_code == 200:
        ...
        print('無法獲取網頁內容')
time.sleep(3)
data.to_csv('富邦comment.csv', index=False, encoding = 'utf-8-sig')

data = pd.read_csv('富邦comment.csv', encoding='utf-8-sig', delimiter=',')
