...
with driver.session() as session:
    card23 = [
        ...
        "富邦Costco聯名卡", "廣三SOGO聯名卡", "台茂聯名卡", "采盟聯名卡", "富邦數位生活_悠遊聯名卡",
        "富邦鈦金卡", "富邦數位生活_一卡通聯名卡", "富邦IMPERIAL_尊御世界卡", "富邦世界卡", "富邦悍將悠遊聯名卡",
        "momo卡", "富邦J卡", "富邦鑽保卡"
    ]
    for card in card23:
        session.write_transaction(create_knowledge_point, "card", "include", card)
...
with driver.session() as session:
    card59 = [
        ...
        "秀泰聯名卡_晶緻卡", "秀泰聯名卡_白金卡", "大葉髙島屋聯名卡_世界卡",
        "大葉髙島屋聯名卡_無限卡", "大葉髙島屋聯名卡_鈦金卡", "大葉髙島屋聯名卡_御璽卡", 
        "大葉髙島屋聯名卡_晶緻卡", "大葉髙島屋聯名卡_白金卡",
