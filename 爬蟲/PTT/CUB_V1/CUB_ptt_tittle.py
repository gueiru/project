...
# 設定目標看板和關鍵字
board = 'creditcard'
keywords = ["KOKO icash聯名卡", "KOKO COMBO悠遊聯名卡", "KOKO COMBO icash聯名卡", "eTag聯名卡", "雙幣卡", "台塑聯名卡", "長榮航空聯名卡" ,"亞洲萬里通聯名卡", "i刷(悠遊)金融卡", "KOKO簽帳金融卡", "商務卡", "現金回饋御璽卡", "世界卡", "蝦皮購物聯名卡", "CUBE卡"]
...
df.to_csv('CUB_ptt_tittle.csv', index=False, encoding = 'utf-8-sig')
print("已完成")
